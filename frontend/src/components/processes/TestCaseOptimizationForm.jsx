...
export default function TestCaseOptimizationForm({ onRun }) {
  ...
  const processOptions = {
    processTitles: ['Test Case A', 'Test Case B', 'Test Case C'],
    ...
    <div className="max-w-2xl mx-auto p-4">
      <form className="space-y-6">
        ...
        <div className="bg-white p-4 rounded-lg shadow">
          <h2 className="text-lg font-semibold mb-4">Test Case Configuration</h2>
        ...
        {matchingResults.length > 0 && (
          <div className="bg-white p-4 rounded-lg shadow">
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-lg font-semibold">Matching Test Cases</h2>
